...
class LinksCollector:
    ...
    def _open_page(self, request):
        ...
        self.driver.find_element('search-form-view__input').send_keys(request)
        sleep(random.uniform(0.4, 0.7))
        self.driver.find_element(name='small-search-form-view__button').click()
        # Нажимаем на кнопку поиска
        sleep(random.uniform(1.4, 2))
        self.slider = self.driver.find_element(name='scroll__scrollbar-thumb')
